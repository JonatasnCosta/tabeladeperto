       ...
       ListView(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Text('Tabela frases em inglês',
            style: TextStyle(
              fontFamily: 'Varela',
              fontSize: 20.0,
         ...
         Row(
           ...
           children: <Widget>[
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: <Widget>[
                Text("People are around the clock \n"
                     "between computer, tablet and smartphone.\n",
                    style: TextStyle(fontFamily: ('Varela'),
                    fontSize: 9.0
                  ),
                ),
         ...
         Row(
           ...
           children: <Widget>[
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: <Widget>[
                Text("These lenses are for you, in addition to being\n"
                     "according to something more refined.\n",
