...
class TabelaDistanciaPositiva extends StatefulWidget {
  final assetPath, cookiename;
    TabelaDistanciaPositiva({this.assetPath, this.cookiename});
  @override
 
  _TabelaDistanciaPositivaState createState() => _TabelaDistanciaPositivaState();
}

class _TabelaDistanciaPositivaState extends State<TabelaDistanciaPositiva> {
